...
CK_RV C_GetTokenInfo(CK_SLOT_ID slotID, CK_TOKEN_INFO_PTR pInfo)
{
    ...
    FILL_INT_BY_JSON(ret, "flags", pInfo->flags);
    FILL_INT_BY_JSON_UNAVAIL(ret, "maxSessionCount", pInfo->ulMaxSessionCount);
    FILL_INT_BY_JSON_UNAVAIL(ret, "sessionCount", pInfo->ulSessionCount);
    FILL_INT_BY_JSON_UNAVAIL(ret, "maxRwSessionCount", pInfo->ulMaxRwSessionCount);
    FILL_INT_BY_JSON_UNAVAIL(ret, "rwSessionCount", pInfo->ulRwSessionCount);
    FILL_INT_BY_JSON(ret, "maxPinLen", pInfo->ulMaxPinLen);
    FILL_INT_BY_JSON(ret, "minPinLen", pInfo->ulMinPinLen);
    FILL_INT_BY_JSON_UNAVAIL(ret, "totalPublicMemory", pInfo->ulTotalPublicMemory);
    FILL_INT_BY_JSON_UNAVAIL(ret, "freePublicMemory", pInfo->ulFreePublicMemory);
    FILL_INT_BY_JSON_UNAVAIL(ret, "totalPrivateMemory", pInfo->ulTotalPrivateMemory);
    FILL_INT_BY_JSON_UNAVAIL(ret, "freePrivateMemory", pInfo->ulFreePrivateMemory);
    FILL_VERSION_BY_JSON(ret, "hardwareVersion", pInfo->hardwareVersion);
    FILL_VERSION_BY_JSON(ret, "firmwareVersion", pInfo->firmwareVersion);
